...
interface NextStepEngineActions {
  ...
  runInference: (letterText: string, patientContext: NextStepPatientContext, sessionId: string, sourceAgentType: string) => Promise<void>;
...
export function useNextStepEngine(
  ...
  }), [runInference, integrateSelected, undo, reset, setCurrentLetter, clearIntegrationError]);
