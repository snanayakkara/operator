...
export class SessionPersistenceService {
  ...
  private compressSession(session: PatientSession): PersistedSession {
    ...
    return {
      ...
      nextStepResult: session.nextStepResult,
      nextStepContext: session.nextStepContext,
  ...
  private decompressSession(persisted: PersistedSession): PatientSession {
    return {
      ...
      nextStepResult: persisted.nextStepResult ?? null,
      nextStepContext: persisted.nextStepContext,
