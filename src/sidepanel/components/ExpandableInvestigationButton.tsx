...
interface ExpandableInvestigationButtonProps {
...
export const ExpandableInvestigationButton: React.FC<ExpandableInvestigationButtonProps> = ({
  onStartWorkflow,
  onQuickAction,
  processingAction,
  isFooter = false
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-gray-600 text-xs mt-1 leading-tight">
                Open investigation summary field
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-start space-x-2">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-gray-600 text-xs mt-1 leading-tight">
                  Voice-to-text with AI formatting
                </div>
              </div>
            </div>
          </button>
