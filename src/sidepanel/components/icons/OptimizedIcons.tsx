 ...
 * 
 * Reduces bundle size by creating lightweight icon components
...
export const MicIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  ...
  >
    <path d="m12 1 0 11"/>
    <path d="m18 7c0 4.97-4.03 9-9 9s-9-4.03-9-9"/>
    <path d="m12 20 0 3"/>
    <path d="m8 23 8 0"/>
  </svg>
);
...
export const StethoscopeIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const CircleDotIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const AlertCircleIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const Loader2Icon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const SquareIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const Volume2Icon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
...
export const PillIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
    ...
    className={className}
  >
    <path d="M10.5 20.5 L3.5 13.5 L10.5 6.5 L17.5 13.5 Z"/>
    <path d="M13.5 3.5 L20.5 10.5 L13.5 17.5 L6.5 10.5 Z"/>
  </svg>
);
...
export const BarChart3Icon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
