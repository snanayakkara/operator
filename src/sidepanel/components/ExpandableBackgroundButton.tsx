...
interface ExpandableBackgroundButtonProps {
...
export const ExpandableBackgroundButton: React.FC<ExpandableBackgroundButtonProps> = ({
  onStartWorkflow,
  onQuickAction,
  processingAction,
  isFooter = false
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-gray-600 text-xs mt-1 leading-tight">
                Access patient background notes
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-start space-x-2">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-gray-600 text-xs mt-1 leading-tight">
                  Voice-to-text with ↪ arrow formatting
                </div>
              </div>
            </div>
          </button>
