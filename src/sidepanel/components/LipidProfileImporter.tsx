...
export const LipidProfileImporter: React.FC<LipidProfileImporterProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-2">
      <div className="bg-white rounded-2xl max-w-[600px] w-full max-h-[92vh] overflow-hidden shadow-xl flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto p-4 space-y-4 bg-surface-secondary">
