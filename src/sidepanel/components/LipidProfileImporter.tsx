          ...
          <section className="bg-white border border-gray-200 rounded-xl p-2.5 shadow-sm">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2">
              <div className="flex items-center gap-1.5">
                ...
                <button
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 text-xs text-gray-700 hover:border-gray-300"
              ...
              <form className="mt-2 space-y-1.5" onSubmit={handlePasteSubmit}>
                ...
                <div className="flex items-center justify-end gap-1.5">
                  <button
                    ...
                    className="px-2 py-1 text-[10px] text-gray-600 hover:text-gray-800"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-blue-600 text-white text-[10px] font-medium hover:bg-blue-700"
                  >
