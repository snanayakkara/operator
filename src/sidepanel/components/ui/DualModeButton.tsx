 ...
 *
 * A split button for actions that support both Dictate and Type modes.
 * Two distinct hit areas within one button:
 * - Left = Dictate (microphone icon)
 * - Right = Type (keyboard icon)
 *
 * Used by: Quick Letter, RHC, Background, Medications, Social History, Bloods, Imaging
 */
...
export const DualModeButton: React.FC<DualModeButtonProps> = memo(({
  id,
  label,
  alias,
  icon: Icon,
  ...
  return (
    ...
    >
      ...
      {/* Expanded state - shows Dictate | Type split */}
      <motion.div
...
DualModeButton.displayName = 'DualModeButton';
